...
$fetch = $categorie->selection_categorie();
$fetch2 = $sous_categorie->selection_sous_categorie();
...
if(isset($_GET['sous_categorie']))
{
    ...
    $fetch6 = $sous_categorie->selection_sous_categorie_nom($id_sous_categorie);
...
if(isset($_GET['categorie']))
{
    ...
    $fetch8 = $categorie->selection_categorie_nom($id_categorie);
