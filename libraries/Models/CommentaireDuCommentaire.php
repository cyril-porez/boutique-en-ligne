<?php
    ...
    class CommentaireDuCommentaire extends Model{
        ...
        public function insertCommentaireCommentaire($commentaire) {

            $date = date('Y-m-d H:i:s');
            //$sql = "INSERT INTO `commentaires`(commentaire, date, id_utilisateur, id_produit) VALUES (:commentaire, :date, 3, 1)";
            $sql = "INSERT INTO `commentaire_du_commentaire`(reponse, date, id_utilisateur, id_commentaire, id_produit) VALUES (:commentaire, :date, 2, 2, 1)";
        ...
        public function afficheReponse(/*$idCommentaire*/) {
            $sql = "SELECT id_commentaire, reponse, commentaire_du_commentaire.date, utilisateurs.nom from commentaire_du_commentaire inner join utilisateurs ON commentaire_du_commentaire.id_utilisateur = utilisateurs.id where id_produit = 1 and id_commentaire = 1";
