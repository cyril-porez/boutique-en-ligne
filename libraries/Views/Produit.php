<?php
    ...
    else if(!isset($_POST['nom']) || !isset($_POST['reference']) || !isset($_POST["classe"]) || !isset($_POST['description']) || !isset($_POST["categorie"]) || !isset($_POST["sous-categorie"]) || !isset($_POST['prix'])){
        echo 'champ vide';
    }
    // var_dump($_FILES);
    // var_dump($_POST);
